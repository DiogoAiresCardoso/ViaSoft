...
type
  ...
  public
    ...
    //criar retorno valor da cedula
    function GetValorCedula(poCedula: TCedula): Double;
  end;
...
implementation
  ...
  function TTroco.GetValorCedula(poCedula: TCedula): Double;
  begin
    Result := CValorCedula[poCedula];
  end;
